...
echo "== 6 on with a tampered hvnode-verify.mjs (must refuse)"; echo "//x" >> /opt/nan-relay/hvnode-verify.mjs; run on T6; cp /t/relay/hvnode-verify.mjs /opt/nan-relay/hvnode-verify.mjs
