# Shared constants and checks for S4 (sourced AFTER ../lib.sh). The release is 79c5ecf2, built by 5d from image commit
# aa6c985c (isolation/m4/evidence/production-release-aa6c985c/ at 08b083e6): a4f22748 with init linked against musl
# (MIT) instead of glibc (Codex, 09-25: Enclave's LICENSE unchanged). Its step 0 is s4-musl.sh. The 4d tree it follows is
# iso-17e182a8 (a4f22748, live since 4d); guestd, the boot path, fwd and the judge equal 17e182a8's.
REL=79c5ecf24eb48a70e2bb20f4bca684b4d5e3c7700f9bf9d38735c19509898ce4; IMG=aa6c985c688e73ffc2ec547b691c2d804e50ad69
SRC=/home/steven/enclave-bench/prod-release-aa6c985c/release-aa6c985c
T=$PROD/iso-aa6c985c; R=$PROD/release-aa6c985c; LEG=$PROD/iso-03be27d6/isolation; LEGC=0181bce3aac5fa03dfaf2928d834ecd04d2a4a73
...
# the installed tree is aa6c985c with no tracked change and no untracked file (ignored build products such as m4/.bundle
