# 4c (sourced AFTER ../pool-rollout-20260925/lib.sh): the node image whose supervisor overlay is b18f8989 (the floor merge's
...
NEWD=/home/steven/Projects/enclave/metal/dist-iso-b18f8989; NEWC=b18f8989b8218baa5e0b07c26490e5f139c118c6
NEWM=$(cat $S4C/build/prediction.txt)
