...
ADMIT=79c5ecf24eb48a70e2bb20f4bca684b4d5e3c7700f9bf9d38735c19509898ce4 bash ~/enclave-bench/rs4-20260925/pkg/accept.sh > $S4C/4ca-accept.txt 2>&1 || fail "the relay slice's acceptance fails after the restart (4ca-accept.txt)"
