# Shared constants and checks for S5 (sourced AFTER ../pool-rollout-20260925/lib.sh): the FIXED release 52156652, built by
# enclave-53 from image commit 4cdd5169 (isolation/front-console-guard: console.go routes everything but the fronts own
# "DOM ..." statements away from the host console; enclave-d1's finding on 79c5ecf2), bf GO. Only template/front and
# release.json differ from 79c5ecf2; init/musl, kernel, firmware, rt/, the boot path, fwd, the judge and guestd are
# byte-identical (53). It follows iso-aa6c985c (79c5ecf2, live since the 09-25 tree switch).
REL=52156652d67a20a71643a5158624058dfeb6b88b58d8de47b360cf0a2a2eb6a1; IMG=4cdd516924981eeacefc8ccaefb4e7fc0e1ec939
SRC=/home/steven/enclave-bench/pub-0181bce3/cut-4cdd5169/release-4cdd5169
T=$PROD/iso-4cdd5169; R=$PROD/release-4cdd5169; LEG=$PROD/iso-03be27d6/isolation; LEGC=0181bce3aac5fa03dfaf2928d834ecd04d2a4a73
...
MAIN=/home/steven/Projects/enclave; S4=$HOME/enclave-bench/s5-20260926; LOG4=$S4/install.log
OT=$PROD/iso-aa6c985c; OREL=79c5ecf24eb48a70e2bb20f4bca684b4d5e3c7700f9bf9d38735c19509898ce4; OIMG=aa6c985c688e73ffc2ec547b691c2d804e50ad69
...
# the installed tree is 4cdd5169 with no tracked change and no untracked file (ignored build products such as m4/.bundle
