...
- **The corresponding source goes out as ONE bundle, distributed next to the release tarball from the same place:**
  ...
  - It holds every file below, SHA256SUMS, and a README naming the releases it covers: 5c3561f9 (this one),
    a4f22748 and 79c5ecf2. All three have the same third-party bytes except 79c5ecf2's init, which links musl, whose
    source is in the bundle too.
