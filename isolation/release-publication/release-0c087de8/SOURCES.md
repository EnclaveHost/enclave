# Corresponding source: domain release 0c087de8 (release id 5db18199…, the W^X-at-attest release)

Release 0c087de8's third-party files are byte-identical to release f7888d86's, and so to 79c5ecf2's
...
- **The corresponding source goes out as ONE bundle, distributed next to the release tarball from the same place:**
  ...
  - **It serves this release unchanged.** 5db18199 has 79c5ecf2's third-party bytes exactly (as 52156652 and f7888d86
    do), and the README does not name either of them. A bundle whose README names more releases would be a different tar
    under the same file name, so it is not made here: at most one such tar may ever be published.
...
- **musl and template/init:**
  ...
  - This repository's isolation/m2/build-musl.sh does exactly that, with the tarball's sha256 and musl's release
    ...
    build-musl.sh) with 0c087de8's dominit.c and app-seccomp.h: 00355508…, 142 libc.a members (INVENTORY.md).
...
0c087de8213ddd6ac7b8ed7e472b02ad23672bd5 on branch isolation/wx-at-attest (INVENTORY.md gives the commands). The
