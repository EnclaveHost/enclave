# Corresponding source: domain release 17e182a8 (release id a4f22748…, the production release)

Release 17e182a8's third-party files are byte-identical to release 0181bce3's (INVENTORY.md; check-third-party.py),
so this is the same corresponding source. For each component that the release ships as a binary, this lists the source that builds those bytes, and the recipe
that built them.
...
- **The corresponding source goes out as ONE bundle, distributed next to the release tarball from the same place:**
  ...
  - It holds every file below, SHA256SUMS, and a README naming the releases it covers: 5c3561f9, a4f22748 (this
    one) and 79c5ecf2. All three have the same third-party bytes except 79c5ecf2's init, which links musl.
...
17e182a8ba192152a83feee4f79d63f8628094e8 (INVENTORY.md gives the commands). The repository LICENSE covers them.
