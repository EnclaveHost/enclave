# Third-party notices: domain release 4cd26e58 (release id aee2059ffcc7bd8a..., the seccomp-statement release)
...
- **In the release:** template/rt/libc.so.6, libm.so.6, ld-linux-x86-64.so.2 (shared, the runtime set wasmtime is dynamically linked with). template/init contains NO glibc: it links musl (below)
...
## musl libc (linked statically into template/init)

- **In the release:** template/init (static: Scrt1.o, crti.o, crtn.o and members of libc.a)
- **Version:** musl 1.2.6, no patches
- **License:** MIT (COPYRIGHT lists the files under other permissive terms)
- **Source:** musl-1.2.6.tar.gz from https://musl.libc.org/releases/, sha256 d585fd3b613c66151fc3249e8ed44f77020cb5e6c1e635a616d3f9f82460512a, signed by musl's release key 836489290BB6B70F99FFDA0556BCDB593020450F (the tarball and its .asc are in the corresponding-source bundle)
- **Texts:** [licenses/musl/COPYRIGHT](licenses/musl/COPYRIGHT)

## GCC runtime libraries (libgcc_s; crtbeginS.o and crtendS.o)

- **In the release:** template/rt/libgcc_s.so.1 (shared); template/init (static: crtbeginS.o and crtendS.o only; its link map takes no member of libgcc.a, libgcc_eh.a or libatomic)
...
| licenses/musl/COPYRIGHT | b870108ec5e7790e9f9919064f1b9421d62d5f9b0e6c230c6adf7ea2da62e97b | corresponding-source: musl-1.2.6.tar.gz: musl-1.2.6/COPYRIGHT |
