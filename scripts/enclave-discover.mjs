...
// schema 3 appended the PROOF KEY, and schema 4 the seller's declared PAYOUT
// WALLET (the wallet whose own deployments a rev-12 ledger hosts here for free
// — set only by that wallet, so a 0x0 here is a box that charges everyone).
// Appended fields keep every earlier
