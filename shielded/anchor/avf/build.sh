...
case "$NAME" in
  ...
  anchor)       # the anchor + the harness's worker client over an fd (wire-fd.c wraps the shipped shielded-wire.c).
                ...
                SRCS=("$HERE/payload/anchor_payload.c" "$HERE/payload/anchor_pins.c" "$HERE/payload/anchor_names.c" "$HERE/payload/anchor_gguf.c" "$HERE/payload/anchor_catalog.c" "$HERE/payload/anchor_encoded_catalog.c" "$HERE/payload/anchor_artifacts.c" "$HERE/payload/anchor_auth.c" "$HERE/payload/anchor_prepare.c" "$HERE/payload/anchor_copy.c" "$CORE/anchor-core.c" "$GG/shielded-simd.c" "$GG/shielded-field.c"
