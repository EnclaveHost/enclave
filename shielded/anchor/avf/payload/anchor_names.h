/* What may land on the pVM's pads port under a given name (anchor_payload.c receiver):
 * a canonical dealt-pad shipment, one of the exact shared-prefix assets, or nothing. */
