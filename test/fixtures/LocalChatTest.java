...
public final class LocalChatTest {
    ...
    public static void main(String[] a) throws Exception {
        ...
        expect(LocalChat.plan(3360161216L, 6, 4096, 1842000000L, 64, 2).equals("LOCAL model_bytes=3360161216 threads=6 ctx=4096 tpu_bundle_bytes=1842000000 bank=64 refill=2"), "tpu plan line");
        expect(LocalChat.withDraft(LocalChat.plan(5, 6, 4096), 170194016L, 9).equals("LOCAL model_bytes=5 threads=6 ctx=4096 draft_bytes=170194016 draft_max=4"), "draft tail clamps");
        System.out.println("{\"status\":\"" + (failed == 0 ? "PASS" : "FAIL") + "\",\"executed_checks\":" + checks + ",\"request\":\"" + LocalChat.request("hello", 256, 700) + "\",\"request_utf8\":\"" + LocalChat.request(snow, 64, 0) + "\",\"plan\":\"" + LocalChat.plan(3360161216L, 6, 4096) + "\",\"plan_tpu\":\"" + LocalChat.plan(3360161216L, 6, 4096, 1842000000L, 64, 2) + "\",\"plan_draft\":\"" + LocalChat.withDraft(LocalChat.plan(3360161216L, 6, 4096, 1842000000L, 64, 2), 170194016L, 4) + "\"}");
