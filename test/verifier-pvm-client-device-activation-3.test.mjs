...
const PINS = JSON.parse(fs.readFileSync(path.join(REPO, "verifier", "integration", "pins.json"), "utf8")), NEXTFILE = JSON.parse(fs.readFileSync(path.join(REPO, "verifier", "integration", "next-builds.json"), "utf8"));
