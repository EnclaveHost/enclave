...
const suites = ["test/verifier-fixtures-tracked.test.mjs", "test/verifier-integration-verdict.test.mjs", "test/verifier-envelope.test.mjs", "test/site-verifier-shadow.test.mjs", "test/verifier-linux-canary.test.mjs", "test/verifier-pvm-v3.test.mjs", "test/verifier-pvm-instance-device.test.mjs", "test/verifier-web-package.test.mjs", "test/verifier-web-x509.test.mjs", "test/verifier-web-differential.test.mjs", "test/verifier-web-shadow.test.mjs", "test/verifier-web-browser.test.mjs", "test/verifier-live-differential.test.mjs", "test/verifier-collateral-cache.test.mjs", "test/verifier-snp-genoa.test.mjs", "test/verifier-snp-turin.test.mjs", "test/verifier-fail-closed.test.mjs", "test/verifier-pvm-device.test.mjs", "test/verifier-pvm-evidence.test.mjs", "test/verifier-pvm-abi2.test.mjs", "test/verifier-admission.test.mjs", "test/verifier-sealed-stream.test.mjs", "test/verifier-sealed-traces.test.mjs", "test/verifier-pvm-client-persistence.test.mjs", "test/verifier-pvm-client-update.test.mjs", "test/verifier-pvm-client-supersede.test.mjs", "test/verifier-pvm-policy-deployments.test.mjs", "test/verifier-pvm-client-ext.test.mjs", "test/verifier-pvm-client-activation.test.mjs", "test/verifier-pvm-client-next.test.mjs", "test/verifier-pvm-client-device-activation.test.mjs", "test/verifier-pvm-client-device-activation-2.test.mjs", "test/verifier-pvm-client-device-activation-3.test.mjs", "test/verifier-pvm-stability-50.test.mjs"];
