// PATCHED for the VBS enclave build (windows/enclave-engine): every _WIN32 branch is disabled under
// __ENCLAVE_PROJECT__ so the POSIX file path (fopen/fread over the enclave's memory filesystem) is used.
// Source: llama.cpp ddd4ec1428a6201e18975ea52b07c71e0f9aef26 src/llama-mmap.cpp; generated by the sync step.
...
#if (defined(_WIN32) && !defined(__ENCLAVE_PROJECT__))
...
#elif (defined(_WIN32) && !defined(__ENCLAVE_PROJECT__))
...
#if defined(_POSIX_MEMLOCK_RANGE) || (defined(_WIN32) && !defined(__ENCLAVE_PROJECT__))
