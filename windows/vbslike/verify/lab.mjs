...
if (A && B) {
  ...
  check("5c the RUNTIME (the probe, as its uid) is REFUSED a report, unfiltered and filtered: the report channel is the front's alone (enclave-87's ruling)", !!probe.report && !!probe.filtered_report && probe.report !== "granted-for-this-domain" && probe.filtered_report !== "granted-for-this-domain" && !probe.report_b64, `${probe.report} / ${probe.filtered_report}`);
